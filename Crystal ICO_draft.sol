...
contract Crowdsale is Ownable {
  ...
  function Crowdsale(MintableToken tokenContract, uint256 _startBlock, uint256 _endBlock, uint256 _rate, address _wallet,/* remember about 18 zeros */ uint256 _limitTokensToSale) {
    ...
    rate = _rate;
    wallet = _wallet;
    limitTokensToSale = _limitTokensToSale;
  ...
  function hasEnded() public constant returns (bool) {
    return ( block.number > endBlock ) || (tokensSold >= limitTokensToSale) ;
